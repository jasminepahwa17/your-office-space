...
const ContactForm = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-12 justify-center w-full mb-12 px-4 lg:px-40">
      ...
      <div className="order-0 flex flex-col gap-2 lg:order-1 lg:w-1/2 w-full lg:pt-12">
        <img src={image} className="" />
        <div className="flex lg:flex-col lg:gap-3 gap-6">
        <div className="flex gap-1 items-center lg:gap-3">
        <img src={phone} className="lg:w-4 w-3" /><p className="underline text-xs lg:text-base hover:text-blue-700"> 91+ 8929564589 </p>
        </div> 
        <div className="flex gap-1 items-center lg:gap-3">
        <img src={mail} className="lg:w-4 w-3"  /> <a className="underline text-xs lg:text-base hover:text-blue-700" href="mailto:yourofficespaces@gmail.com" >yourofficespaces@gmail.com</a>
        </div> 
        </div>
